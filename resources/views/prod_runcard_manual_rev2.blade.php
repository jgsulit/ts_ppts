                  ...
                  <div class="row row_container">
                    <div class="col">
                      <div class="input-group input-group-sm mb-3">
                        ...
                        <input type="text" value="N/A" class="form-control form-control-sm" id="txt_JRDJKSDCGJDoc_revision" name="txt_JRDJKSDCGJDoc_revision">
                      </div>
                    </div>
                  </div>
                  <div class="row row_container">
      ...
      dt_prod_runcard      = $('#tbl_prod_runcard').DataTable({
        "processing" : true,
          ...
          "drawCallback": function(row,data,index ){
            ...
            console.log('GetMaterialKittingListByPoNo')
